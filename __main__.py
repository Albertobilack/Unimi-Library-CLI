...
if __name__ == "__main__":
    ...
    biblio_list.set_defaults(func=list_library)
...
#farei stessa cosa anche per  orario
    ...
    biblio_book.add_argument("-now", help="reserve your spot instantly instead of waiting until midnight", action=argparse.BooleanOptionalAction)
    ...
    biblio_book.set_defaults(func=book_library)
    ...
    biblio_freespot.set_defaults(func=freespot_library)
